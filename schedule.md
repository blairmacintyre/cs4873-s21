...
|[Week 9](#week-9):<br>Mar 15|**(M)** Surveillance / USA Patriot Act<br>Slides ([Perusall](https://app.perusall.com/courses/computing-society-and-professionalism/slides-16-surveillance) [pdf](slides/16-surveillance.pdf))<br>Video ([Perusall](https://app.perusall.com/courses/computing-society-and-professionalism/pre-recording-march-15-surveillance-and-patriot-act))<br>Discussion Guide ([file]())<br>**(W)** *Tuesday is break day, so we'll do only one lecture this week to reduce the workload. There will still be a discussion section.*||
