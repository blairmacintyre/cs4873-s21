...
|[Week 8](#week-8):<br>Mar 8|**(M)** Privacy <br>Slides ([Perursall](https://app.perusall.com/courses/computing-society-and-professionalism/slides-14-privacy) [pdf](slides/14-privacy.pdf))<br>Video ([Perusall](https://app.perusall.com/courses/computing-society-and-professionalism/pre-recording-march-8-privacy)) **(W)** Privacy and the Government<br>Discussion Guide (file)|HW: [Fair Use](hw4)|
